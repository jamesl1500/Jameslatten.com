...
<div class="home">
    <!-- Top Area Introduction -->
    <div class="topIntroduction">
        <div class="innerTopIntroduction">
            <h3>Welcome</h3>
            <p>I'm James Latten - Web developer, designer, writer, and a future nurse from Ohio.</p>

            <div class="links">
                <a data-toggle="tooltip" title="Twitter" href="https://twitter.com/jaye_aesthetic"><i class="fab fa-twitter"></i></a> 
                <a data-toggle="tooltip" title="Tumblr" href="https://jayeglizzy.tumblr.com/"><i class="fab fa-tumblr"></i></a> 
                <a data-toggle="tooltip" title="Instagram" href="https://www.instagram.com/jaye.aesthetic/"><i class="fab fa-instagram"></i></a> 
                <a data-toggle="tooltip" title="Medium" href="https://medium.com/@jaye.aesthetic"><i class="fab fa-medium"></i></A> 
            </div>
        </div>
    </div>
